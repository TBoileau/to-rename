 ...
 */
final class Version20220916122120 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE video (id INT AUTO_INCREMENT NOT NULL, logo_id INT DEFAULT NULL, live_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, season INT NOT NULL, episode INT NOT NULL, description LONGTEXT NOT NULL, thumbnail VARCHAR(255) NOT NULL, youtube_id VARCHAR(255) NOT NULL, tags JSON NOT NULL, status varchar(8) NOT NULL, INDEX IDX_7CC7DA2CF98F144A (logo_id), INDEX IDX_7CC7DA2C1DEBA901 (live_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
