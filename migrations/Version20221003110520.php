 ...
 */
final class Version20221003110520 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, image VARCHAR(255) NOT NULL, template LONGTEXT NOT NULL, parameters JSON NOT NULL, choices JSON NOT NULL, target_entity VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_64C19C15E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE live (id INT AUTO_INCREMENT NOT NULL, planning_id INT NOT NULL, content_id INT NOT NULL, lived_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', season INT NOT NULL, episode INT NOT NULL, duration_hours INT NOT NULL, duration_minutes INT NOT NULL, duration_seconds INT NOT NULL, INDEX IDX_530F2CAF3D865311 (planning_id), INDEX IDX_530F2CAF84A0A3ED (content_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
